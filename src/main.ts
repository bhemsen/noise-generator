...
<footer><p>MADE FOR QUIET MOMENTS · 100% CLIENT SIDE · NO ACCOUNT</p><nav class="footer-links" aria-label="Rechtliches und Links"><a href="impressum.html">Impressum</a><a href="datenschutz.html">Datenschutz</a><a href="https://bhemsen.de" target="_blank" rel="noopener">bhemsen.de</a></nav><a class="sponsor" href="https://github.com/sponsors/TODO-GITHUB-USER" target="_blank" rel="noopener">♥ Sponsor on GitHub</a></footer>
